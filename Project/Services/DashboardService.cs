...
public class DashboardService : IDashboardService
{
    ...
    public Task<DashboardSummaryDto> GetSummaryAsync(string? period, CancellationToken cancellationToken = default) =>
        _repo.GetSummaryAsync(period, cancellationToken);
